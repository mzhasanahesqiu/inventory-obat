...
<body>
  ...
  <div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DATA DOKTER</h1>
    <hr>
    <p>Berikut dibawah ini merupakan data dokter</p>
    <?php
    if ($_SESSION['posisi'] == "admin") {
    ?>
      <h4>
        <a href="dokter_tambah.php" class="btn btn-info">Tambah Dokter</a>
    ...
    <div class="table-responsive text-center">
      <table class="table table-striped table-bordered table-hover align-middle">
        ...
        <tbody>
          ...
          if ($keyword != '') {
            $data = mysqli_query($koneksi, "SELECT * FROM dokter WHERE kd_dokter LIKE '%" . $keyword . "%' OR nama LIKE '%" . $keyword . "%' OR spesialis LIKE '%" . $keyword . "%'");
          } else {
          ...
          ?>
            ...
            <tr>
              ...
              ?>
                <td>
                  <a href="dokter_detail.php?kd_dokter=<?= $baris['kd_dokter']; ?>" class="btn btn-primary">Detail</a>
                  <a href="dokter_edit.php?kd_dokter=<?= $baris['kd_dokter']; ?>" class="btn btn-warning">Edit</a>
                  <a href="dokter_hapus.php?kd_dokter=<?= $baris['kd_dokter']; ?>" class="btn btn-danger">Hapus</a>
                </td>
              <?php
