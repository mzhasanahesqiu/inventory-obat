...
<div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DETAIL DATA STOK OBAT</h1><hr>
    <p>Berikut dibawah ini merupakan detail data stok obat</p>
    <h4>
        <a href="obat_tampil.php" class="btn btn-dark">Kembali</a>
	</h4>
    <div class="table-responsive text-center">
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM stok WHERE kd_obat='$kd_obat'");
