...
<!-- style navigasi bar atas-->
	...
	<h4>
		<a href="dokter_tampil.php" class="btn btn-info">Lihat Data Dokter</a>
	</h4>
	<h4>Edit Data Dokter</h4>
			...
			<form action="dokter_editpro.php?kd_dokter=<?= $kd_dokter ?>" method="POST">
			<div class="form-group row">
			    <label for="kd_dokter" class="col-sm-2 col-form-label">Kode Dokter</label>
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="kd_dokter" id="kd_dokter" value="<?php echo $baris['kd_dokter']; ?>" disabled>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="spesialis" id="spesialis" value="<?php echo $baris['spesialis']; ?>">
				</div>
			</div>
            <div class="form-group row">
