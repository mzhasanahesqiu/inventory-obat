...
<!-- style navigasi bar atas-->
	...
	<div class="container-xl mt-4 p-5  bg-light">
		<h1 align="left mb-2">Menu Data Stok Obat</h1><hr>
		<h4>
			<a href="obat_tampil.php" class="btn btn-outline-info">Lihat Data Stok Obat</a>
		</h4>
		<h5>Tambah Data Stok Obat</h5>

			<!-- fungsi untuk menambah data melalui form -->
			<form action="obat_tambahpro.php" method="POST">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="stok" id="stok">
					</div>
				</div>
				<div class="form-group row">
					<label for="kadaluarsa" class="col-sm-2 col-form-label">Kedaluwarsa</label>
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="kadaluarsa" id="kadaluarsa">
					</div>
				</div>
