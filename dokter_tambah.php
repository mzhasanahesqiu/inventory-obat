...
<!-- style navigasi bar atas-->
	...
	<div class="container-xl mt-4 p-5  bg-light">
		<h1 align="left mb-2">Menu Dokter</h1><hr>
		<h4>
			<a href="dokter_tampil.php" class="btn btn-outline-info">Lihat Data Dokter</a>
		</h4>
		<h5>Tambah Data Dokter</h5>

			<!-- fungsi untuk menambah data melalui form -->
			<form action="dokter_tambahpro.php" method="POST">
			<div class="form-group row">
			    <label for="kd_dokter" class="col-sm-2 col-form-label">Kode Dokter</label>
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="kd_dokter" id="kd_dokter">
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="spesialis" id="spesialis">
				</div>
			</div>
            <div class="form-group row">
			    <label for="alamat" class="col-sm-2 col-form-label">Alamat</label>
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="alamat" id="alamat">
				</div>
			</div>
            <div class="form-group row">
			    <label for="no_tlp" class="col-sm-2 col-form-label">Nomor Telefon</label>
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="no_tlp" id="no_tlp">
				</div>
			</div>
