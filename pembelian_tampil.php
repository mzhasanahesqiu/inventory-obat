...
<body>
  ...
  <div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DATA PEMBELIAN</h1>
    <hr>
    <p>Berikut dibawah ini merupakan data pembelian</p>
    <?php
    if ($_SESSION['posisi'] == "admin" || $_SESSION['posisi'] == "gudang") {
    ?>
      <h4>
        <a href="pembelian_tambah.php" class="btn btn-info">Tambah Pembelian</a>
    ...
    <div class="table-responsive text-center">
      <table class="table table-striped table-bordered table-hover align-middle">
        ...
        <tbody>
          ...
          if ($keyword != '') {
            $data = mysqli_query($koneksi, "SELECT * FROM pembelian WHERE kd_beli LIKE '%" . $keyword . "%' OR kd_obat LIKE '%" . $keyword . "%'");
          } else {
          ...
          ?>
            ...
            <tr>
              ...
              <td><?= $baris['kd_obat'] ?></td>
              <td><?= $baris['harga'] ?></td>
              <td><?= $baris['tgl_beli'] ?></td>
              <?php
              if ($_SESSION['posisi'] == "admin" || $_SESSION['posisi'] == "gudang") {
              ?>
                <td>
                  <a href="pembelian_detail.php?kd_beli=<?= $baris['kd_beli']; ?>" class="btn btn-primary">Detail</a>
                  <a href="pembelian_edit.php?kd_beli=<?= $baris['kd_beli']; ?>" class="btn btn-warning">Edit</a>
                  <a href="pembelian_hapus.php?kd_beli=<?= $baris['kd_beli']; ?>" class="btn btn-danger">Hapus</a>
                </td>
              <?php
              } else if ($_SESSION['posisi'] == "kepala") {
              ?>
