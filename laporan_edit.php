...
<?php
    ...
    <?php
		include "koneksi.php";
		$no = $_GET['no'];
		$data = mysqli_query($koneksi, "SELECT * FROM laporan WHERE no='$no'");
...
<nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-success">
    ...
    <div class="container-xl mt-4 p-5  bg-light">
        <form action="laporan_editpro.php?no=<?= $no ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control mt-1 mb-1" name="bulan" id="bulan" value="<?php echo $baris['bulan']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="eksistensi" class="col-sm-2 col-form-label">Eksistensi</label>
                    <div class="col-sm-10">
                    <input type="text" class="form-control mt-1 mb-1" name="eksistensi" id="eksistensi" value="<?php echo $baris['eksistensi']; ?>">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="file" class="col-sm-2 col-form-label">Pilih file</label>
                    <div class="col-sm-10">
                    <input type="file" class="form-control mt-1 mb-1" name="file" id="file" value="<?php echo $baris['file']; ?>">
                    </div>
                </div>
                <br>
                <div class="form-group row">
                    <div class="col-sm-10">
                        <input type="submit" name="upload" id="upload" value="Edit" class="btn btn-primary mt-3"></input>
                    </div>
                </div>
            </form>
    </div>
