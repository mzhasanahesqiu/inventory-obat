...
<div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DETAIL DATA SUPPLIER</h1><hr>
    <p>Berikut dibawah ini merupakan detail data supplier</p>
    <h4>
        <a href="supplier_tampil.php" class="btn btn-dark">Kembali</a>
	</h4>
