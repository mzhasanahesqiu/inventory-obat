...
<body>
  ...
  <div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DATA KARYAWAN</h1>
    <hr>
    <p>Berikut dibawah ini merupakan data karyawan</p>
    <?php
    if ($_SESSION['posisi'] == "admin") {
    ?>
      <h4>
        <a href="karyawan_tambah.php" class="btn btn-info">Tambah Karyawan</a>
    ...
    <div class="table-responsive text-center">
      <table class="table table-striped table-bordered table-hover align-middle">
        ...
        <tbody>
          ...
          if ($keyword != '') {
            $data = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE kd_petugas LIKE '%" . $keyword . "%' OR nama LIKE '%" . $keyword . "%'");
          } else {
          ...
          ?>
            <tr>
              ...
              ?>
                <td>
                  <a href="karyawan_detail.php?kd_petugas=<?= $baris['kd_petugas']; ?>" class="btn btn-primary">Detail</a>
                  <a href="karyawan_edit.php?kd_petugas=<?= $baris['kd_petugas']; ?>" class="btn btn-warning">Edit</a>
                  <a href="karyawan_hapus.php?kd_petugas=<?= $baris['kd_petugas']; ?>" class="btn btn-danger">Hapus</a>
                </td>
              <?php
