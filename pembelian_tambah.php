...
<!-- style navigasi bar atas-->
	...
	<h5>Tambah Data Pembelian</h5>
			...
			<form action="pembelian_tambahpro.php" method="POST">
				<div class="form-group row">
					<label for="kd_beli" class="col-sm-2 col-form-label">Kode Pembelian</label>
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="kd_beli" id="kd_beli">
					</div>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="harga" id="harga">
					</div>
				</div>
				<div class="form-group row">
					<label for="tgl_beli" class="col-sm-2 col-form-label">Tanggal Beli</label>
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="tgl_beli" id="tgl_beli">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-sm-10">
