...
<!-- style navigasi bar atas-->
	...
	<div class="container-xl mt-4 p-5  bg-light">
		<h1 align="left mb-2">Menu Supplier</h1><hr>
		<h4>
			<a href="supplier_tampil.php" class="btn btn-outline-info">Lihat Data Supplier</a>
		</h4>
		<h5>Tambah Data Supplier</h5>

			<!-- fungsi untuk menambah data melalui form -->
			<form action="supplier_tambahpro.php" method="POST">
				<div class="form-group row">
					<label for="kd_supplier" class="col-sm-2 col-form-label">Kode Supplier</label>
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="kd_supplier" id="kd_supplier">
					</div>
				</div>
				<div class="form-group row">
