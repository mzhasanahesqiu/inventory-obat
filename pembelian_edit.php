...
<!-- style navigasi bar atas-->
	...
	<h1 align="left mb-2">Menu Pembelian</h1><hr>
	<h4>
		<a href="pembelian_tampil.php" class="btn btn-outline-info">Lihat Data Pembelian</a>
	</h4>
	<h5>Edit Data Pembelian</h5>

			<!-- fungsi untuk memanggil data dalam database -->
			<?php
			include "koneksi.php";
			$kd_beli = $_GET['kd_beli'];
			$data = mysqli_query($koneksi, "SELECT * FROM pembelian WHERE kd_beli='$kd_beli'");
			$baris = mysqli_fetch_array($data);
			?>

			<form action="pembelian_editpro.php?kd_beli=<?= $kd_beli ?>" method="POST">
				<div class="form-group row">
					<label for="kd_beli" class="col-sm-2 col-form-label">Kode Pembelian</label>
					<div class="col-sm-10">
					<input type="number" class="form-control mt-1 mb-1" name="kd_beli" id="kd_beli" value="<?php echo $baris['kd_beli']; ?>" disabled>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="harga" id="harga" value="<?php echo $baris['harga']; ?>">
					</div>
				</div>
				<div class="form-group row">
					<label for="tgl_beli" class="col-sm-2 col-form-label">Tanggal Beli</label>
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="tgl_beli" id="tgl_beli" value="<?php echo $baris['tgl_beli']; ?>">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-sm-10">
