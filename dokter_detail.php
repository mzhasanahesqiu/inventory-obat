...
<div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DETAIL DATA DOKTER</h1><hr>
    <p>Berikut dibawah ini merupakan detail data dokter</p>
    <h4>
        <a href="dokter_tampil.php" class="btn btn-dark">Kembali</a>
	</h4>
    <div class="table-responsive text-center">
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM dokter WHERE kd_dokter='$kd_dokter'");
