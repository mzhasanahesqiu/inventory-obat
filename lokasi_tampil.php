...
<body>
  ...
  <div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DATA LOKASI OBAT</h1>
    <hr>
    <p>Berikut dibawah ini merupakan data lokasi obat</p>
    <?php
    if ($_SESSION['posisi'] == "admin") {
    ?>
      <h4>
        <a href="lokasi_tambah.php" class="btn btn-info">Tambah Lokasi Obat</a>
    ...
    <div class="table-responsive text-center">
      <table class="table table-striped table-bordered table-hover align-middle">
        ...
        <tbody>
          ...
          if ($keyword != '') {
            $data = mysqli_query($koneksi, "SELECT * FROM lokasi WHERE kd_obat LIKE '%" . $keyword . "%' OR nama_obat LIKE '%" . $keyword . "%' OR jenis_obat LIKE '%" . $keyword . "%'");
          } else {
          ...
          ?>
            ...
            <tr>
              ...
              <td><?= $baris['lokasi_obat'] ?></td>
              <?php
              if ($_SESSION['posisi'] == "admin") {
              ?>
                <td>
                  <a href="lokasi_detail.php?kd_obat=<?= $baris['kd_obat']; ?>" class="btn btn-primary">Detail</a>
                  <a href="lokasi_edit.php?kd_obat=<?= $baris['kd_obat']; ?>" class="btn btn-warning">Edit</a>
                  <a href="lokasi_hapus.php?kd_obat=<?= $baris['kd_obat']; ?>" class="btn btn-danger">Hapus</a>
                </td>
              <?php
              } else if ($_SESSION['posisi'] == "kepala") {
              ?><td>
