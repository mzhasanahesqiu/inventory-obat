...
<div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DETAIL DATA PELANGGAN</h1><hr>
    <p>Berikut dibawah ini merupakan detail data pelanggan</p>
    <h4>
        <a href="pelanggan_tampil.php" class="btn btn-dark">Kembali</a>
	</h4>
