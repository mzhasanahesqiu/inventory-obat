...
<body>
  ...
  <div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DATA SUPPLIER</h1>
    <hr>
    <p>Berikut dibawah ini merupakan data supplier</p>
    <?php
    if ($_SESSION['posisi'] == "admin") {
    ?>
      <h4>
        <a href="supplier_tambah.php" class="btn btn-info">Tambah Supplier</a>
    ...
    <div class="table-responsive text-center">
      <table class="table table-striped table-bordered table-hover align-middle">
        ...
        <tbody>
          ...
          if ($keyword != '') {
            $data = mysqli_query($koneksi, "SELECT * FROM supplier WHERE kd_supplier LIKE '%" . $keyword . "%' OR nama LIKE '%" . $keyword . "%'");
          } else {
          ...
          ?>
            ...
            <tr>
              ...
              ?>
                <td>
                  <a href="supplier_detail.php?kd_supplier=<?= $baris['kd_supplier']; ?>" class="btn btn-primary">Detail</a>
                  <a href="supplier_edit.php?kd_supplier=<?= $baris['kd_supplier']; ?>" class="btn btn-warning">Edit</a>
                  <a href="supplier_hapus.php?kd_supplier=<?= $baris['kd_supplier']; ?>" class="btn btn-danger">Hapus</a>
                </td>
              <?php
