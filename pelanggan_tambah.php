...
<!-- style navigasi bar atas-->
	...
	<br><br>
		...
		<h1 align="left mb-2">Menu Data Pelanggan</h1><hr>
			<h4>
				<a href="pelanggan_tampil.php" class="btn btn-outline-info">Lihat Data Pelanggan</a>
			</h4>
			<h5>Tambah Data Pelanggan</h5>

				<!-- fungsi untuk menambah data melalui form -->
				<form action="pelanggan_tambahpro.php" method="POST">
				<div class="form-group row">
					<label for="kd_pelanggan" class="col-sm-2 col-form-label">Kode Pelanggan</label>
					<div class="col-sm-10">
					<input type="text" class="form-control mt-1 mb-1" name="kd_pelanggan" id="kd_pelanggan">
					</div>
				</div>
				<div class="form-group row">
