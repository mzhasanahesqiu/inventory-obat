...
<div class="container-xl mt-4 p-5  bg-light">
    <h1 align="left mb-2">DETAIL DATA PEMBELIAN</h1><hr>
    <p>Berikut dibawah ini merupakan detail data pembelian</p>
    <h4>
        <a href="pembelian_tampil.php" class="btn btn-dark">Kembali</a>
	</h4>
    <div class="table-responsive text-center">
        ...
        $query = mysqli_query($koneksi, "SELECT * FROM pembelian WHERE kd_beli='$kd_beli'");
