...
<!-- style navigasi bar atas-->
	...
	<h4>
		<a href="lokasi_tampil.php" class="btn btn-info">Lihat Lokasi Obat</a>
	</h4>
	<h4>Edit Lokasi Obat</h4>
			...
			$data = mysqli_query($koneksi, "SELECT * FROM lokasi WHERE kd_obat='$kd_obat'");
			$baris = mysqli_fetch_array($data);
			?>

			<form action="lokasi_editpro.php?kd_obat=<?= $kd_obat ?>" method="POST">
			<div class="form-group row">
			    <label for="kd_obat" class="col-sm-2 col-form-label">Kode Obat</label>
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="kd_obat" id="kd_obat" value="<?php echo $baris['kd_obat']; ?>" disabled>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="jenis_obat" id="jenis_obat" value="<?php echo $baris['jenis_obat']; ?>">
				</div>
			</div>
            <div class="form-group row">
			    <label for="lokasi_obat" class="col-sm-2 col-form-label">Lokasi Obat</label>
			    <div class="col-sm-10">
			    <input type="text" class="form-control mt-1 mb-1" name="lokasi_obat" id="lokasi_obat" value="<?php echo $baris['lokasi_obat']; ?>">
				</div>
			</div>
			<div class="form-group row">
				<div class="col-sm-10">
